...
<head>
    ...
    <title>Analogy Questions</title>
</head>
<body style="background-image:url(bg/2.jpg); background-repeat:no-repeat; background-attachment:fixed; background-position:center; background-size:cover; font-family:Lucida Sans Unicode;">

<div style="background-color:rgba(255,255,255,0.7); border-radius:25px; padding:30px; margin-left:500px; margin-top:30px; margin-right:500px;" align="center">
